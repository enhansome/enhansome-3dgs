...
* SplaTAM: Splat, Track & Map 3D Gaussians for Dense RGB-D SLAM, CVPR 2024. \[[Paper](https://arxiv.org/pdf/2312.02126.pdf) | [Code](https://github.com/spla-tam/SplaTAM) ⭐ 2,199 | 🐛 53 | 🌐 Python | 📅 2024-06-19]
* Gaussian Splatting SLAM, CVPR 2024 \[[Paper](https://arxiv.org/abs/2312.06741) | [Code](https://github.com/muskie82/MonoGS) ⭐ 2,166 | 🐛 101 | 🌐 Python | 📅 2024-08-07]
* Gaussian-SLAM: Photo-realistic Dense SLAM with Gaussian Splatting, \[[Paper](https://ivi.fnwi.uva.nl/cv/paper/GaussianSLAM.pdf) | [Code](https://github.com/VladimirYugay/Gaussian-SLAM) ⭐ 1,184 | 🐛 0 | 🌐 Python | 📅 2024-07-03]
* Photo-SLAM: Real-time Simultaneous Localization and Photorealistic Mapping for Monocular, Stereo, and RGB-D Cameras, \[[Paper](https://arxiv.org/pdf/2311.16728.pdf) | [Code](https://github.com/HuajianUP/Photo-SLAM) ⭐ 773 | 🐛 38 | 🌐 C++ | 📅 2024-06-12]
...
* Splatter Image: Ultra-Fast Single-View 3D Reconstruction, \[[Paper](https://arxiv.org/abs/2312.13150) | [Code](https://github.com/szymanowiczs/splatter-image) ⭐ 1,110 | 🐛 19 | 🌐 Python | 📅 2024-08-17]
...
* DreamGaussian4D: Generative 4D Gaussian Splatting, \[[Paper](https://arxiv.org/abs/2312.17142) | [Code](https://github.com/jiawei-ren/dreamgaussian4d) ⭐ 619 | 🐛 11 | 🌐 Python | 📅 2024-06-10]
...
* [NeRFStudio](https://github.com/nerfstudio-project/nerfstudio/blob/main/colab/demo.ipynb) ⭐ 12,022 | 🐛 958 | 🌐 Python | 📅 2025-07-29
* [Camenduru](https://github.com/camenduru/gaussian-splatting-colab) ⭐ 514 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2023-12-19

### Training

* [nerfstudio: python/CUDA](https://github.com/nerfstudio-project/gsplat) ⭐ 5,724 | 🐛 368 | 🌐 Python | 📅 2026-09-19
* [fast: C++/CUDA](https://github.com/MrNeRF/gaussian-splatting-cuda) ⭐ 3,763 | 🐛 221 | 🌐 C++ | 📅 2026-09-24
...
* [Playcanvas](https://github.com/playcanvas/supersplat) ⭐ 10,254 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-23
...
* [Unity Implementation](https://github.com/aras-p/UnityGaussianSplatting) ⭐ 3,416 | 🐛 43 | 🌐 C# | 📅 2025-10-17
...
* [Gaussian Splatting](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,970 | 🐛 713 | 🌐 Python | 📅 2025-10-17
* [MrNeRF](https://github.com/MrNeRF/awesome-3D-gaussian-splatting/tree/main) ⭐ 8,905 | 🐛 7 | 🌐 Python | 📅 2026-09-12
